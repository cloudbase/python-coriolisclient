...
class EndpointSourceOption(base.Resource):
    pass


class EndpointSourceOptionsManager(base.BaseManager):
    resource_class = EndpointSourceOption

    def __init__(self, api):
        super(EndpointSourceOptionsManager, self).__init__(api)
