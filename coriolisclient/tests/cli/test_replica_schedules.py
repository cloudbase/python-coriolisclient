...
class ReplicaScheduleFormatterTestCase(test_base.CoriolisBaseTestCase):
    ...
    def setUp(self):
        ...
        self.replica = replica_schedules.TransferScheduleFormatter()
...
class ReplicaScheduleDetailFormatterTestCase(test_base.CoriolisBaseTestCase):
    ...
    def setUp(self):
        ...
        self.replica = replica_schedules.TransferScheduleDetailFormatter()
...
class CreateReplicaScheduleTestCase(test_base.CoriolisBaseTestCase):
    ...
    def setUp(self):
        ...
        self.replica = replica_schedules.CreateTransferSchedule(
    ...
    @mock.patch.object(replica_schedules.TransferScheduleDetailFormatter,
...
class ShowReplicaScheduleTestCase(test_base.CoriolisBaseTestCase):
    ...
    def setUp(self):
        ...
        self.replica = replica_schedules.ShowTransferSchedule(
            self.mock_app, mock.sentinel.app_args)
...
class UpdateReplicaScheduleTestCase(test_base.CoriolisBaseTestCase):
    ...
    def setUp(self):
        ...
        self.replica = replica_schedules.UpdateTransferSchedule(
            self.mock_app, mock.sentinel.app_args)
...
class DeleteReplicaScheduleTestCase(test_base.CoriolisBaseTestCase):
    ...
    def setUp(self):
        ...
        self.replica = replica_schedules.DeleteTransferSchedule(
            self.mock_app, mock.sentinel.app_args)
...
class ListReplicaScheduleTestCase(test_base.CoriolisBaseTestCase):
    ...
    def setUp(self):
        ...
        self.replica = replica_schedules.ListTransferSchedule(
            self.mock_app, mock.sentinel.app_args)
    ...
    @mock.patch.object(replica_schedules.TransferScheduleFormatter,
                       'list_objects')
    def test_take_action(
        self,
        mock_list_objects
