...
class EndpointManagerTestCase(
    ...
    def test_get(
        ...
        mock_get.assert_called_once_with('/endpoints/sentinel.id', 'endpoint')
    ...
    def test_get_endpoint_id_for_name(
        ...
        mock_validate_uuid_string.return_value = None
