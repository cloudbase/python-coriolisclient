...
class ReplicaScheduleManagerTestCase(test_base.CoriolisBaseTestCase):
    ...
    @mock.patch.object(replica_schedules.ReplicaScheduleManager,
                       "_format_rfc3339_datetime")
    def test_create(self, mock_format_rfc3339_datetime, mock_post):
        expected_data = {
            "schedule": mock.sentinel.schedule,
            "enabled": True,
            "expiration_date": mock_format_rfc3339_datetime.return_value,
        ...
        mock_format_rfc3339_datetime.assert_called_once_with(
            mock.sentinel.expiration_date)
    ...
    @mock.patch.object(replica_schedules.ReplicaScheduleManager,
                       "_format_rfc3339_datetime")
    def test_update(self, mock_format_rfc3339_datetime, mock_put):
        updated_values = {"expiration_date": mock.sentinel.expiration_date}
