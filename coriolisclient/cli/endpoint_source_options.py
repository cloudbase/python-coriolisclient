...
class ListEndpointSourceOptions(lister.Lister):
    """ List endpoint source environment options. """
    ...
    def take_action(self, args):
        ...
        edo = self.app.client_manager.coriolis.endpoint_source_options
        obj_list = edo.list(
            endpoint_id, environment=environment, option_names=options)
        return EndpointSourceOptionFormatter().list_objects(obj_list)
